...
# This file is copied from legacy way of using thumbor storages, thus we did not fix lint errors
# pylint: disable=invalid-overridden-method,redefined-builtin,arguments-differ,logging-not-lazy,inconsistent-return-statements,invalid-name
